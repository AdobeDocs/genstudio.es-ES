...
Puede cargar documentos de directrices de marca (hasta tres archivos de PDF o DOC) en GenStudio for Performance Marketing para crear automáticamente una marca. Consulte [Agregar directrices](add-guidelines.md) para obtener información sobre cómo agregar una marca a GenStudio for Performance Marketing, modificarla, publicarla y mucho más.
